...
// using MovieService.SyncDataServices.Grpc;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            // {
                ...
                services.AddDbContext<AppDbContext>(opt =>
                    opt.UseSqlServer(Configuration.GetConnectionString("MoviesConn")));
            // }
            // else
            // {
            ...
            services.AddHttpClient<ITicketDataClient, HttpTicketDataClient>();
            ...
            Console.WriteLine($"--> TicketService Endpoint {Configuration["TicketService"]}");
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseEndpoints(endpoints =>
            {
                ...
                // endpoints.MapGrpcService<GrpcMovieService>();
